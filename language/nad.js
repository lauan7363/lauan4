...
exports.noregis = () => {
	return`*「🌹」SEM REGISTRO*\n*Para se registrar use ${prefix}daftar nome|idade* \n\n*exemplo ${prefix}daftar BOT|18*`
}

exports.baned = () => {
	return`*Esse usuário foi banido de utilizar o menu e alguns comandos do Lauan-bot!*`
}
...
exports.bug = () => {
	return`*O problema foi relatado ao Lauan🌹*`
}

exports.wrongf = () => {
	return`*Coloque o texto*\n\n*Exemplo: !efeitin2 Lauan/Teste*`
}
